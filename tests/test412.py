...
class TestEnums( unittest.TestCase):
    def test_enum(self):
        ...
        self.assertEqual( var.value.value, 2)        
        var.kill
        task.kill
...
class TestStructures( unittest.TestCase):
    ...
    def test_complexStructure(self):
        ...
        self.assertEqual( var.value['.matrix'], [[1000.0, 1001.0, 1002.0, 1003.0], [1010.0, 1011.0, 1012.0, 1013.0], 
        ...
        self.assertEqual (var.value['.myStruct1'], b'\x03!,7\x03!,7')
        self.assertEqual(var.value['.myStruct2'], b'\x03!,7')
        self.assertEqual(var.value['.myStruct3'], b'\x03!,7\x03!,7\x03!,7')
        self.assertEqual(var.value['.myStruct4'], b'\x03!,7\x03!,7\x03!,7\x03!,7\x03!,7\x03!,7\x03!,7\x03!,7\x03!,7\x03!,7\x03!,7\x03!,7')
        self.assertEqual( var.value['.myEnum'], myEnumType.drei)
        self.assertEqual( var.value['.myEnum'].value, 2)
